<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wf_EstadoIncidente.aspx.vb"
    Inherits="WEB_DINCI.wf_EstadoIncidente" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>DINCI | Estados</title>
        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="img/user.jpg" style="height:1.69;width:1.69" />
                             </span>
            ...
            <li>
                <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Listado Incidentes</span> <span class="fa arrow"></span></a>                
            </li> 
            <li>
                <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Estado Incidentes</span> <span class="fa arrow"></span></a>
            </li>                              
        </ul>
