<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wf_MantenimientoIncidente.aspx.vb"
    Inherits="WEB_DINCI.wf_MantenimientoIncidente" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>DINCI | Incidentes</title>
            ...
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                    ...
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><asp:Label ID="LBL_USUARIO" runat="server"></asp:Label> </strong>
                             </span>  </a>                    
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <!-- tabla de listado -->
                              ...
                              <asp:GridView ID="GV_ListadoIncidentes" runat="server"></asp:GridView>
                              </div>
